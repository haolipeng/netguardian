...
public:
    ...
    void set_eth_offset(uint16_t offset) { protocol_stack_.l2.offset = offset; }
    void set_ip_offset(uint16_t offset) { protocol_stack_.l3.offset = offset; }
    void set_transport_offset(uint16_t offset) { protocol_stack_.l4.offset = offset; }
    void set_payload_offset(uint16_t offset) { protocol_stack_.l7.offset = offset; }
